...
void Dilation2D::operator()(const Waveform<short>& waveformVec,  
                            Waveform<short>&       dilationVec)  const
{
    getDilation<short>(waveformVec, dilationVec);
}

void Dilation2D::operator()(const Waveform<float>& waveformVec,  
                            Waveform<float>&       dilationVec)  const
{
    getDilation<float>(waveformVec, dilationVec);
}

void Dilation2D::operator()(const Waveform<double>& waveformVec,  
...
template <typename T> void icarus_signal_processing::Dilation2D::getDilation(const Waveform<T>& inputWaveform,
...
void Erosion2D::operator()(const Waveform<short>& waveformVec,  
                           Waveform<short>&       erosionVec)  const
{
    getErosion<short>(waveformVec, erosionVec);
}

void Erosion2D::operator()(const Waveform<float>& waveformVec,  
                           Waveform<float>&       erosionVec)  const
{
    getErosion<float>(waveformVec, erosionVec);
}

void Erosion2D::operator()(const Waveform<double>& waveformVec,  
...
template <typename T> void icarus_signal_processing::Erosion2D::getErosion(const Waveform<T>& inputWaveform,
...
void Gradient2D::operator()(const Waveform<short>& waveformVec,  
                            Waveform<short>&       gradientVec)  const
{
    getGradient<short>(waveformVec, gradientVec);
}

void Gradient2D::operator()(const Waveform<float>& waveformVec,  
                            Waveform<float>&       gradientVec)  const
{
    getGradient<float>(waveformVec, gradientVec);
}

void Gradient2D::operator()(const Waveform<double>& waveformVec,  
                            Waveform<double>&       gradientVec)  const
{
    getGradient<double>(waveformVec, gradientVec);
}

template <typename T> void icarus_signal_processing::Gradient2D::getGradient(const Waveform<T>& inputWaveform,
...
void Average2D::operator()(const Waveform<short>& waveformVec,  
                           Waveform<short>&       averageVec)  const
{
    getAverage<short>(waveformVec, averageVec);
}

void Average2D::operator()(const Waveform<float>& waveformVec,  
                           Waveform<float>&       averageVec)  const
{
    getAverage<float>(waveformVec, averageVec);
}

void Average2D::operator()(const Waveform<double>& waveformVec,  
                           Waveform<double>&       averageVec)  const
{
    getAverage<double>(waveformVec, averageVec);
}

template <typename T> void icarus_signal_processing::Average2D::getAverage(const Waveform<T>& inputWaveform,
...
void Median2D::operator()(const Waveform<short>& waveformVec,  
                          Waveform<short>&       medianVec)  const
{
    getMedian<short>(waveformVec, medianVec);
}

void Median2D::operator()(const Waveform<float>& waveformVec,  
                          Waveform<float>&       medianVec)  const
{
    getMedian<float>(waveformVec, medianVec);
}

void Median2D::operator()(const Waveform<double>& waveformVec,  
                          Waveform<double>&       medianVec)  const
{
    getMedian<double>(waveformVec, medianVec);
}

template <typename T> void icarus_signal_processing::Median2D::getMedian(const Waveform<T>& inputWaveform,
